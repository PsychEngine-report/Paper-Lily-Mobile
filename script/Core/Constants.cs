...
namespace LacieEngine.Core
{
	public class Constants
	{
		...
		public static class Colors
		{
			...
			public static readonly Color Passthrough = new Color(1f, 0f, 1f, 0.42f);

			public static readonly Color SpecialEvent = new Color(0f, 1f, 0f, 0.42f);
		}
		...
		public static class PhysicsLayers
		{
			...
			public const uint Interactables = 1u;

			public const uint Walls = 2u;

			public const uint Player = 4u;

			public const uint Passthrough = 8u;

			public const uint Pushables = 16u;
		}
