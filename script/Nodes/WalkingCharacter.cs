...
namespace LacieEngine.Nodes
{
	public abstract class WalkingCharacter : KinematicBody2D, ITurnable, IWalker, IPhysicsInterpolated
	{
		...
		public static readonly Vector2 FLOOR_OFFSET = new Vector2(0f, -4f);

		public static readonly Vector2 GRAVITY_2D_WALK = new Vector2(0f, 80f);

		public static readonly Vector2 GRAVITY_2D_RUN = new Vector2(0f, 150f);
		...
		private static readonly Dictionary<IWalker.MoveSpeed, float> _animationSpeeds = new Dictionary<IWalker.MoveSpeed, float>();
		...
		public void WalkToPoint(Vector2 point)
		{
			...
			Direction dir = Direction.FromVector(point - base.Position);
			AutoDirection = dir;
		}
