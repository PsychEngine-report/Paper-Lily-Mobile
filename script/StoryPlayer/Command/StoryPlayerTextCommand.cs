...
namespace LacieEngine.StoryPlayer
{
	...
	public class StoryPlayerTextCommand : StoryPlayerCommand
	{
		...
		public override IList<string> GetDependencies()
		{
			...
			{
				foreach (Match match2 in TextDisplayManager.ItemTagRegex.Matches(Text))
				{
					dependencies.Add("res://assets/sprite/common/item/" + Items.Get(match2.Groups[1].Value).Icon + ".png");
				}
			}
			return dependencies;
		}
