...
namespace LacieEngine.Minigames
{
	public class PointAndClick : Control, IMinigame
	{
		...
		public virtual void Init()
		{
			...
			{
				Dictionary<string, string> dictionary = (EventTargets = new Dictionary<string, string>());
			}
			if (CloseEventTargets == null)
			{
				Dictionary<string, string> dictionary = (CloseEventTargets = new Dictionary<string, string>());
			}
			if (FunctionTargets == null)
			{
				Dictionary<string, string> dictionary = (FunctionTargets = new Dictionary<string, string>());
			}
		}
