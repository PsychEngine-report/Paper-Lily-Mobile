...
namespace LacieEngine.Subgame.Chapter1
{
	...
	public class Ch1ForestCenter : GameRoom
	{
		...
		[GetNode("Other/Events/misc_log_nosit_1")]
		private IToggleable nEvtNoSit1;

		[GetNode("Other/Events/misc_log_nosit_2")]
		private IToggleable nEvtNoSit2;

		[GetNode("Main/misc_stump/Chair")]
		private IToggleable nLogChair1;

		[GetNode("Main/misc_stump3/Chair")]
		...
		public override void _UpdateRoom()
		{
			...
			else if ((bool)varKozmoLeaking.Value)
			{
				...
				nEvtNoSit1.Enabled = true;
				nEvtNoSit2.Enabled = true;
				nLogChair1.Enabled = false;
				nLogChair2.Enabled = false;
			}
			else
			{
				nEvtNoSit1.Enabled = false;
				nEvtNoSit2.Enabled = false;
				nLogChair1.Enabled = true;
				nLogChair2.Enabled = true;
			}
