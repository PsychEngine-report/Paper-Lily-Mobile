...
namespace LacieEngine.Modules.Tutorials
{
	...
	{
		private const string CAPTION_GROUP = "tutorials";
		...
		public Tutorial LoadTutorial(string id)
		{
			...
			tutorial.Id = id;
			ApplyCaptions(tutorial);
			return tutorial;
		}

		public void ApplyCaptions(Tutorial tutorial)
		{
			tutorial.Name = Game.Language.GetCaption("tutorials", tutorial.Name, TutorialNameContext(tutorial));
			tutorial.Text = Game.Language.GetCaption("tutorials", tutorial.Text, TutorialTextContext(tutorial));
		}
